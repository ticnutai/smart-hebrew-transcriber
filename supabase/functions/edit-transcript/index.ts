    ...
    if (customPrompt) {
      ...
      switch (action) {
        case 'improve':
          ...
          break;
        case 'fix_errors':
          systemPrompt = 'אתה עורך לשוני מקצועי בעברית. תקן את כל שגיאות הכתיב, הדקדוק והפיסוק בטקסט הבא. אל תשנה את התוכן או המשמעות - רק תקן שגיאות. החזר את הטקסט המתוקן בלבד.';
          break;
        case 'split_paragraphs':
          systemPrompt = 'אתה עורך מקצועי. חלק את הטקסט הבא לפסקאות לוגיות לפי נושאים. הוסף שורה ריקה בין פסקאות. אל תשנה את התוכן עצמו, רק הוסף חלוקה לפסקאות במקומות המתאימים. החזר את הטקסט המחולק בלבד.';
          break;
        case 'fix_and_split':
          systemPrompt = 'אתה עורך לשוני מקצועי בעברית. בצע שני דברים על הטקסט הבא: 1) תקן את כל שגיאות הכתיב, הדקדוק והפיסוק. 2) חלק את הטקסט לפסקאות לוגיות לפי נושאים עם שורה ריקה ביניהן. אל תשנה את התוכן או המשמעות. החזר את הטקסט המתוקן והמחולק בלבד.';
          break;
        case 'sources':
